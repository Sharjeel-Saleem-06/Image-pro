...
const ImageConverter = () => {
  ...
  const convertSingleFile = async (fileData: ProcessedFile): Promise<ProcessedFile> => {
    try {
      ...
      const convertedBlob = await convertImageFormat(fileData.originalFile, {
  ...
  const updateFileFormat = (id: string, format: string) => {
    setFiles(prev => prev.map(f => 
      f.id === id ? { ...f, outputFormat: format, status: 'pending' } : f
    ));
  };
                ...
                {showAdvanced && (
                  ...
                  >
                    <Alert>
                      ...
                      <AlertDescription>
                        Advanced settings will be applied to all new uploads. 
                        Individual files can be customized below.
                      </AlertDescription>
                    </Alert>
                  </motion.div>
                )}
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-300">
                              ...
                              {file.sizeAfter && (
                                <span className={`ml-2 ${
                                  file.sizeAfter < file.sizeBefore ? 'text-green-600' : 'text-orange-600'
                                }`}>
